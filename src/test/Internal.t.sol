...
contract InternalTest is Setup {
    ...
    function test_UsdrValueInDai() public {
        pearlLPCompounderExt = new PearlLPCompounderExt(tokenAddrs["USDC-USDR-lp"], "PearlLPCompounderExt");
        address tokenIn = tokenAddrs["USDR"];
        uint256 amount = 1e9;
        uint256 valueInDai = pearlLPCompounderExt.getValueInDai(tokenIn, amount);
    ...
    function test_WethValueInDai() public {
        pearlLPCompounderExt = new PearlLPCompounderExt(tokenAddrs["WETH-USDR-lp"], "PearlLPCompounderExt");
    ...
    function test_WbtcValueInDai() public {
        pearlLPCompounderExt = new PearlLPCompounderExt(tokenAddrs["WBTC-USDR-lp"], "PearlLPCompounderExt");
